...
void MainWindow::helpUsePC()
{
	...
	tr("点击<b>[Start PC]</b>按钮: 开启点云,再点击关闭 <br> \
		...
		快捷方式<b>[Ctrl + ~]</b>: 切换染色模式 <br> \
		快捷方式<b>[Ctrl + s]</b>: 进入选择点云数据点模式, 再按关闭 <br> \
		快捷方式<b>[Ctrl + 1]</b>:增大点云点的尺寸 <br> \
		快捷方式<b>[Ctrl + 2]</b>:减小点云点的尺寸 <br> \
		快捷方式<b>[Ctrl + 3]</b>:增大点云刻度字体 <br> \
		快捷方式<b>[Ctrl + 4]</b>:减小点云刻度字体 <br> \
