...
print
print 'rosbag2unity, Eyal Reizer 2020, based on the rosbag2video tool by Abel Gabor 2019, based on the tool by Maximilian Laiacker 2016'
print
    ...
    while t_video[topic] < t_file[topic]/opt_rate :
        if not topic in p_avconv:
            ...
            if opt_out_file=="":
                ...
                out_file = bagfile.replace(".bag", ".mp4")
                print "output video file........................ ", out_file, "."
            else:
