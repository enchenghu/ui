...
#define BLOGE(format, ...) printf(L_RED"%s %ld %ld E " LOG_TAG ": " format "\n"NONE_COLOR, get_stime().c_str(), getpid(), gettid(), ##__VA_ARGS__)
#define BLOGI(format, ...) printf(L_GREEN"%s %ld %ld I " LOG_TAG ": " format "\n"NONE_COLOR, get_stime().c_str(), getpid(), gettid(), ##__VA_ARGS__)
#define BLOGD(format, ...) printf(YELLOW"%s %ld %ld D " LOG_TAG ": " format "\n"NONE_COLOR, get_stime().c_str(), getpid(), gettid(), ##__VA_ARGS__)
