#include "hesai_pandar128.h"

#include "hesai/pandar128.h"

HesaiPandar128::HesaiPandar128(
...
void HesaiPandar128::convertToPclPointCloud(Frame& frame) {
...
bool HesaiPandar128::getPointInfo(size_t idx, std::vector<double>& data) {
...
bool HesaiPandar128::getPointUID(size_t idx, int& uid) {
  if (idx >= current_frame_.raw_pointcloud->points.size()) {
    return false;
  }
  auto& p = current_frame_.raw_pointcloud->points[idx];
...
bool HesaiPandar128::initFromConfig(std::shared_ptr<autox::pointview::Config>
...
bool HesaiPandar128::storeToConfig(
...
void HesaiPandar128::initPointFilterSetting(
    autox::pointview::PointFilterSetting& point_filter_setting) {
...
bool HesaiPandar128::updatePlayerState(autox::pointview::PlayerCmd cmd) {
