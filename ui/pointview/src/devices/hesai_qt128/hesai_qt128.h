#ifndef HESAI_QT128_H
#define HESAI_QT128_H
...
class HesaiQt128 : public autox::pointview::DeviceBase {
  Q_OBJECT

 public:
  using RawPointCloud = autox::drivers::hesai::PointCloud;
  ...
  HesaiQt128(std::shared_ptr<autox::pointview::DisplayContext> context,
 ...
 private:
  ...
  QStringList table_head_{"laser_id", "encoder",   "elevation",   "azimuth",
                          ...
                          "y",        "z"};
  // driver
  std::shared_ptr<autox::drivers::hesai::DriverQt128> driver_;
