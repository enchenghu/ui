...
"""autogenerated by genpy from arbe_msgs/arbeFusionQueriesVec.msg. Do not edit."""
import codecs
import sys
...
class arbeFusionQueriesVec(genpy.Message):
  _md5sum = "ba44955926ecbdeed3c3d177166ac4a8"
  _type = "arbe_msgs/arbeFusionQueriesVec"
...
"""
  __slots__ = ['header','queries']
  _slot_types = ['std_msgs/Header','arbe_msgs/arbeFusionQuery[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(arbeFusionQueriesVec, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = arbe_msgs.msg.arbeFusionQuery()
        _x = val1
        start = end
        end += 25
