...
"""autogenerated by genpy from arbe_msgs/arbeFrameTypes.msg. Do not edit."""
import codecs
import sys
...
class arbeFrameTypes(genpy.Message):
  _md5sum = "60a899865eb222277c4a73fdc879e6e4"
  _type = "arbe_msgs/arbeFrameTypes"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """uint8 Frame_Type_3d_short = 1
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(arbeFrameTypes, self).__init__(*args, **kwds)
